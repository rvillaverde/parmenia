! function(t, e) {
    ...
    return function(t) {
        ...
        function o(t, e, n, f, p) {
            t !== e && a(e, function(a, c) {
                if (s(a)) p || (p = new r), u(t, e, c, n, o, f, p);
                else {
                    var d = f ? f(l(t, c), a, c + "", t, e, p) : void 0;
        ...
        var r = n(38),
            ...
            f = function t(e) {
                ...
                var u = !1;
                r.modules && (u = r.modules.slice()), this.options = i()({}, r, a.a), !1 !== u && (this.options.modules = u), document.execCommand("enableObjectResizing", !1, "false"), this.quill.root.addEventListener("click", this.handleClick, !1), this.quill.root.parentNode.style.position = this.quill.root.parentNode.style.position || "relative", this.moduleClasses = this.options.modules, this.modules = []
            };
        ...
        function o(t, e) {
            var n = a(t),
                ...
                y = h.length;
            for (var v in t) !e && !f.call(t, v) || d && ("length" == v || l && ("offset" == v || "parent" == v) || p && ("buffer" == v || "byteLength" == v || "byteOffset" == v) || s(v, y)) || h.push(v);
            return h
        }
        var r = n(54),
            i = n(28),
        ...
        function o(t, e, n, o, x, m, _) {
            var j = b(t, n),
                w = b(e, n),
                O = _.get(w);
            if (O) return void r(t, n, O);
            var S = m ? m(j, w, n + "", t, e, _) : void 0,
                E = void 0 === S;
            if (E) {
                var A = l(w),
                    z = !A && p(w),
                    C = !A && !z && v(w);
                S = w, A || z || C ? l(j) ? S = j : f(j) ? S = u(j) : z ? (E = !1, S = i(w, !0)) : C ? (E = !1, S = a(w, !0)) : S = [] : y(w) || c(w) ? (S = j, c(j) ? S = g(j) : h(j) && !d(j) || (S = s(w))) : E = !1
            }
            E && (_.set(w, S), x(S, w, o, m, _), _.delete(w)), r(t, n, S)
        }
        var r = n(18),
            i = n(57),
            a = n(58),
