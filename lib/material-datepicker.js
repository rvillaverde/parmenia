  ...
  _createClass(MaterialDatepicker, [{
    ...
    value: function draw() {
      ...
      if (this.settings.type == 'date') {
        ...
        var thisMinDate = this.settings.minDate;
        ...
        var _loop = function _loop(_num, _i) {
          ...
          if (thisMinDate && new Date(_this3.date.toISOString()).setDate(_num) < thisMinDate) {
            var containerPickerChooseDay = document.createElement('span');
            containerPickerChooseDay.classList.add("mp-picker-choose-day--disabled");
          } else {
            var containerPickerChooseDay = document.createElement('a');
          }
          containerPickerChooseDay.classList.add("mp-picker-choose-day");
          ...
          containerPickerChooseDay.addEventListener('click', function (event) {
            if (this.classList.contains("mp-picker-choose-day--disabled")) {
              return;
            }
